...
@section('title', 'Create a new Driver')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Create new a Driver</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <form action="{{ route('driver.store') }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" id="alamat" cols="10" rows="10"
                                    class="form-control @error('alamat') is_invalid @enderror" placeholder="Alamat" value="{{ old('alamat') }}"
                                    required></textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tanggal_lahir"
                                    ...
                                    placeholder="Tanggal Lahir" id="basic-datepicker" value="{{ old('tanggal_lahir') }}"
                                    required />
                                @error('tanggal_lahir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input type="radio" id="kawin" name="status_kawin" class="form-check-input"
                                        ...
                                        {{ old('status_kawin') == 'Sudah Menikah / Kawin' ? 'checked' : '' }} required>
                                ...
                                <div class="form-check">
                                    <input type="radio" id="lajang" name="status_kawin" class="form-check-input"
                                        value="Lajang" {{ old('status_kawin') == 'Lajang' ? 'checked' : '' }} required>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_sim" class="form-control" data-toggle="select2" data-width="100%">
                                    <option selected disabled>Jenis SIM</option>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/default.png') }}" alt=""
                                        class="rounded img-preview" style="width: 150px; object-fit: cover">
                                </div>
                            </div>
                            <div class="mb-3">
