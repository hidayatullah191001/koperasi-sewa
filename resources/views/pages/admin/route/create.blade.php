    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Create new a Route</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form action="{{ route('route.store') }}" method="POST"  class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="harga_tiket" class="form-label">Harga per Tiket <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('harga_tiket') is_invalid @enderror autonumber" data-currency-symbol="Rp "
                                name="harga_tiket" id="harga_tiket" placeholder="Harga per Tiket"
                        ...
                        <div class="mb-3">
                            <label for="harga_carteran" class="form-label">Harga Carteran <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('harga_carteran') is_invalid @enderror autonumber" data-currency-symbol="Rp "
                                name="harga_carteran" id="harga_carteran" placeholder="Harga Carteran"
                                value="{{ old('harga_carteran') }}" required />
                        ...
                        <div class="col-lg-2 mb-3">
                            ...
                            <input type="time" class="form-control @error('jam_pemberangkatan') is_invalid @enderror"
                                ...
                                value="{{ old('jam_pemberangkatan') }}" required />
