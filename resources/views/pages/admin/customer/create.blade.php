...
@section('title', 'Create Ticket Customer')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Create new a ticket Customer</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <form action="{{ route('customer.store') }}" method="POST" class="needs-validation" novalidate
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tanggal"
                                    ...
                                    id="basic-datepicker" value="{{ old('tanggal') }}" required />
                                @error('tanggal')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" minlength="16" maxlength="16" name="nik"
                                    ...
                                    id="thresholdconfig" value="{{ old('nik') }}" required />
                                @error('nik')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-lg-2">
                                ...
                                <input type="number" name="umur"
                                    ...
                                    value="{{ old('umur') ?? 0 }}" min="0" required />
                                @error('umur')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" id="alamat" cols="10" rows="10"
                                    class="form-control @error('alamat') is_invalid @enderror" placeholder="Alamat" required>{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="w-100 me-3">
                                    <label for="photo_ktp" class="form-label">Photo KTP <span class="text-danger">*</span></label>
                                    <input type="file" name="photo_ktp" id="photo_ktp" class="form-control" placeholder="Photo Profile" onchange="previewImage()" required />
                                </div>
                                <div class="flex-shrink-0">
                                    <img style="width: 150px; height: 80px; object-fit: cover" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Picture_icon_BLACK.svg/1200px-Picture_icon_BLACK.svg.png" class="rounded img-preview" alt="">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" minlength="12" maxlength="13" name="no_telephone"
                                    class="form-control" placeholder="No Telepon" value="{{ old('no_telephone') }}"
                                    id="thresholdconfig" />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('harga_tiket') }}" placeholder="Harga per Tiket" required />
                                @error('harga_tiket')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Harga Bagasi" value="{{ old('harga_bagasi') }}" />
                                @error('harga_bagasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="keterangan_bagasi"
                                    ...
                                    placeholder="Keterangan Bagasi" value="{{ old('keterangan_bagasi') }}" />
